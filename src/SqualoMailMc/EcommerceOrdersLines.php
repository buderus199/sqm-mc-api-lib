 ...
 */
class SqualoMailMc_EcommerceOrdersLines extends SqualoMailMc_Abstract
{
    /**
    ...
    public function add($storeId,$orderId,$id,$productId,$productVariantId,$quantity,$price)
    {
        $_params=array('id'=>$id,'product_id'=>$productId,'product_variant_id'=>$productVariantId,'quantity'=>$quantity,
            'price'=>$price);
        return $this->master->call('/ecommerce/stores/'.$storeId.'/orders/'.$orderId,'/lines',$_params,SqualoMailMc::POST);
    }
    ...
    public function getAll($storeId,$orderId,$fields=null,$excludeFields=null,$count=null,$offset=null)
    {
        ...
        return $this->master->call('/ecommerce/stores/'.$storeId.'/orders/'.$orderId,'/lines',$_params,SqualoMailMc::GET);
    }
    ...
    public function get($storeId,$orderId,$lineId,$fields=null,$excludeFields=null)
    {
        ...
        if($fields) $_params['fields'] = $fields;
        if($excludeFields) $_params['exclude_fields'] = $excludeFields;
        return $this->master->call('/ecommerce/stores/'.$storeId.'/orders/'.$orderId,'/lines/'.$lineId,$_params,SqualoMailMc::GET);
    }
    ...
    public function modify($storeId,$orderId,$lineId,$productId=null,$productVariantId=null,$quantity=null,$price=null)
    {
        ...
        return $this->master->call('/ecommerce/stores/'.$storeId.'/orders/'.$orderId,'/lines/'.$lineId,$_params,SqualoMailMc::PATCH);
    }
    ...
    {
        return $this->master->call('/ecommerce/stores/'.$storeId.'/orders/'.$orderId,'/lines/'.$lineId,null,SqualoMailMc::DELETE);
    }
}

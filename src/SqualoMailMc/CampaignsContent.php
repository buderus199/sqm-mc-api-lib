 ...
 */
class SqualoMailMc_CampaignsContent extends SqualoMailMc_Abstract
{
    /**
    ...
    public function get($campaignId,$fields=null,$excludeFields=null)
    {
        ...
        return $this->master->call('campaigns/'.$campaignId.'/content',$_params,SqualoMailMc::GET);
    }
    ...
    public function modify($campaignId,$plainText=null,$html=null,$url=null,$template=null,$archive=null,$variateContents=null)
    {
        ...
        return $this->master->call('campaigns/'.$campaignId.'/content',$_params,SqualoMailMc::PUT);
    }
}
 ...
 */
class SqualoMailMc_Conversations extends SqualoMailMc_Abstract
{
    /**
     * @var SqualoMailMc_ConversationsMessages
     */
    public $messages;
                           ...
                           $campaignId=null)
    {
        ...
        return $this->master->call('conversations',$_params,SqualoMailMc::GET);
    }
    ...
    public function get($conversationId,$fields=null,$excludeFields=null)
    {
        ...
        if ($fields) $_params['fields'] = $fields;
        if ($excludeFields) $_params['exclude_fields'] = $excludeFields;
        return $this->master->call('conversations/'.$conversationId,$_params,SqualoMailMc::GET);
    }
}
 ...
 */
class SqualoMailMc_ListsGrowthHistory extends SqualoMailMc_Abstract
{
    /**
    ...
    public function getAll($listId,$fields=null,$excludeFields=null,$count=null,$offset=null)
    {
        ...
        return $this->master->call('lists/'.$listId.'/growth-history',$_params,SqualoMailMc::GET);
    }
    ...
    public function get($listId,$month,$fields=null,$excludeFields=null)
    {
        ...
        if($fields) $_params['fields'] = $fields;
        if($excludeFields) $_params['exclude_fields'] = $excludeFields;
        return $this->master->call('lists/'.$listId.'/growth-history/'.$month,$_params,SqualoMailMc::GET);

...
class SqualoMailMc_Lists extends SqualoMailMc_Abstract
{
    /**
     * @var SqualoMailMc_ListsSegments
     */
    public $segments;
    /**
     * @var SqualoMailMc_ListsAbuseReports
     */
    public $abuseReports;
    /**
     * @var SqualoMailMc_ListsActivity
     */
    public $activity;
    /**
     * @var SqualoMailMc_ListsClients
     */
    public $clients;
    /**
     * @var SqualoMailMc_ListsGrowthHistory
     */
    public $growthHistory;
    /**
     * @var SqualoMailMc_ListsInterestCategory
     */
    public $interestCategory;
    /**
     * @var SqualoMailMc_ListsMembers
     */
    public $members;
    /**
     * @var SqualoMailMc_ListsMergeFields
     */
    public $mergeFields;
    /**
     * @var SqualoMailMc_ListsWebhooks
     */
    public $webhooks;
                        ...
                        $visibility='pub')
    {
        ...
        return $this->master->call('lists',$_params,SqualoMailMc::POST);
    }
                                ...
                                $beforeCampaignLastSent=null,$sinceCampaignLastSent=null,$email=null)
    {
        ...
        if($id) {
            return $this->master->call('lists/'.$id, $_params, SqualoMailMc::GET);
        }
        else
        {
            return $this->master->call('lists/', $_params, SqualoMailMc::GET);
        }
    }
                         ...
                         $emailTypeOption=null,$visibility=null)
    {
        ...
        return $this->master->call('lists/'.$listId, $_params, SqualoMailMc::PATCH);
    }
    ...
    {
        return $this->master->call('lists/'.$listId, null, SqualoMailMc::DELETE);
    }
}
 ...
 */
class SqualoMailMc_ListsMergeFields extends SqualoMailMc_Abstract
{
    /**
    ...
    public function getAll($listId,$fields=null,$excludeFields=null,$count=null,$offset=null,$type=null,$required=null)
    {
        ...
        return $this->master->call('lists/'.$listId.'/merge-fields',$_params,SqualoMailMc::GET);
    }
    ...
    {
        return $this->master->call('lists/'.$listId.'/merge-fields/'.$mergeId,null,SqualoMailMc::GET);
    }
                        ...
                        $options=null,$helpText=null)
    {
        ...
        return $this->master->call('lists/'.$listId.'/merge-fields/',$_params,SqualoMailMc::POST);
    }
                           ...
                           $displayOrder,$options=null,$helpText=null)
    {
        ...
        if($options) $_params['options'] = $options;
        if($helpText) $_params['help_text'] = $helpText;
        return $this->master->call('lists/'.$listId.'/merge-fields/'.$mergeId,$_params,SqualoMailMc::PATCH);
    }
    ...
    {
        return $this->master->call('lists/'.$listId.'/merge-fields/'.$mergeId,null,SqualoMailMc::DELETE);
    }
}
 ...
 */
class SqualoMailMc_ListsMembers extends SqualoMailMc_Abstract
{
    /**
     * @var SqualoMailMc_ListsMembersActivity
     */
    public $memberActivity;
    /**
     * @var SqualoMailMc_ListsMembersGoals
     */
    public $memberGoal;
    /**
     * @var SqualoMailMc_ListsMembersNotes
     */
    public $memberNotes;
    ...
    public function add($listId, $status, $emailAddress, $emailType=null, $mergeFields=null, $interests=null,
        ...
        return $this->master->call('lists/'.$listId.'/members', $_params, SqualoMailMc::POST);
    }
                        ...
                        $beforeTimestampOpt=null,$sinceLastChanged=null,$beforeLastChanged=null,$uniqueEmailId=null)
    {
        ...
        return $this->master->call('lists/'.$listId.'/members',$_params,SqualoMailMc::GET);
    }
    ...
    public function get($listId,$subscriberHash,$fields=null,$excludeFields=null)
    {
        ...
        if($fields) $_params['fields'] = $fields;
        if($excludeFields) $_params['exclude_fields'] = $excludeFields;
        return $this->master->call('lists/'.$listId.'/members/'.$subscriberHash,$_params,SqualoMailMc::GET);
    }
    ...
    public function update($listId,$subscriberHash,$emailType=null,$status=null, $mergeFields=null,$interests=null,$language=null,$vip=null,$location=null)
    {
        ...
        if($vip) $_params['vip'] = $vip;
        if($location) $_params['location'] = $location;
        return $this->master->call('lists/'.$listId.'/members/'.$subscriberHash,$_params,SqualoMailMc::PATCH);
    }
                                ...
                                $emailAddress,$statusIfNew=null)
    {
        ...
        return $this->master->call('lists/'.$listId.'/members/'.$subscriberHash,$_params,SqualoMailMc::PUT);
    }
    ...
    {
        return $this->master->call('lists/'.$listId.'/members/'.$subscriberHash,null,SqualoMailMc::DELETE);
    }
}
 ...
 */
class SqualoMailMc_ListsSegments extends SqualoMailMc_Abstract
{
    /**
     * @var SqualoMailMc_ListsSegmentsMembers
     */
    ...
    public function getInformation($listId,$fields=null)
    {
        ...
        return $this->master->call('lists/'.$listId.'/segments',$_params,SqualoMailMc::GET);
    }
    ...
    {
        return $this->master->call('lists/'.$listId.'/segments/'.$segmentId,null,SqualoMailMc::GET);
    }
    ...
    public function add($listId,$name,$staticSegment=null,$options=null)
    {
        ...
        return $this->master->call('lists/'.$listId.'/segments',$_params,SqualoMailMc::POST);
    }
    /**
     * @param $listId                   The unique id for the list.
     * @param $segmentId                The unique id for the segment.
    ...
    public function modify($listId,$segmentId,$name,$staticSegment=null,$options=null)
    {
        ...
        if($staticSegment) $_params['static_segment'] = $staticSegment;
        if($options) $_params['options'] = $options;
        return $this->master->call('lists/'.$listId.'/segments/'.$segmentId,$_params,SqualoMailMc::PATCH);
    }
    ...
    {
        return $this->master->call('lists/'.$listId.'/segments/'.$segmentId,null,SqualoMailMc::DELETE);
    }
}
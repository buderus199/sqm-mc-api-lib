 ...
 */
class SqualoMailMc_ListsMembersNotes extends SqualoMailMc_Abstract
{
    /**
    ...
    public function add($listId,$subscriberHash,$note=null)
    {
        ...
        return $this->master->call('lists/'.$listId.'/members/'.$subscriberHash,$_params,SqualoMailMc::POST);
    }
    ...
    public function getAll($listId,$subscriberHash,$fields=null,$excludeFields=null,$count=null,$offset=null)
    {
        ...
        return $this->master->call('lists/'.$listId.'/members/'.$subscriberHash.'/notes',$_params,SqualoMailMc::GET);
    }
    ...
    public function get($listId,$subscriberHash,$noteId,$fields=null,$excludeFields=null)
    {
        ...
        if($fields) $_params['fields'] = $fields;
        if($excludeFields) $_params['exclude_fields'] = $excludeFields;
        return $this->master->call('lists/'.$listId.'/members/'.$subscriberHash.'/notes/'.$noteId,$_params,SqualoMailMc::GET);
    }
    ...
    public function modify($listId,$subscriberHash,$noteId,$note=null)
    {
        $_params = array();
        if($note) $_params['note'] = $note;
        return $this->master->call('lists/'.$listId.'/members/'.$subscriberHash.'/notes/'.$noteId,$_params,SqualoMailMc::PATCH);
    }
    public function delete($listId,$subscriberHash,$noteId)
    {
        return $this->master->call('lists/'.$listId.'/members/'.$subscriberHash.'/notes/'.$noteId,null,SqualoMailMc::DELETE);
    }
}
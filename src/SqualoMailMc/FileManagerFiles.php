 ...
 */
class SqualoMailMc_FileManagerFiles extends SqualoMailMc_Abstract
{
    /**
    ...
    public function add($folderId=null,$name,$fileData)
    {
        ...
        return $this->master->call('file-manager/files',$_params,SqualoMailMc::POST);
    }
                           ...
                           $beforeCreatedAt=null,$sinceCreatedAt=null,$sortField=null,$sortDir=null)
    {
        ...
        return $this->master->call('file-manager/files',$_params,SqualoMailMc::GET);
    }
    ...
    public function get($fileId,$fields=null,$excludeFields=null)
    {
        ...
        if($fields) $_params['fields'] = $fields;
        if($excludeFields) $_params['exclude_fields'] = $excludeFields;
        return $this->master->call('file-manager/files/'.$fileId,$_params,SqualoMailMc::GET);
    }
    ...
    public function modify($fileId,$folderId=null,$name,$fileData)
    {
        $_params=array('name'=>$name,'file_data'=>$fileData);
        if($folderId) $_params['folder_id'] = $folderId;
        return $this->master->call('file-manager/files/'.$fileId,$_params,SqualoMailMc::PATCH);
    }
    ...
    {
        return $this->master->call('file-manager/files/'.$fileId,null,SqualoMailMc::DELETE);
    }
}
 ...
 */
class SqualoMailMc_EcommerceProductsVariants extends SqualoMailMc_Abstract
{
    /**
                        ...
                        $imageUrl=null,$backorders=null,$visibility=null)
    {
        ...
        $this->master->call('/ecommerce/stores/'.$storeId.'/products/'.$productId.'/variants',$_params,SqualoMailMc::POST);
    }
    ...
    public function getAll($storeId,$productId,$fields=null,$excludeFields=null,$count=null,$offset=null)
    {
        ...
        $this->master->call('ecommerce/stores/'.$storeId.'/products/'.$productId.'/variants',$_params,SqualoMailMc::GET);
    }
    ...
    public function get($storeId,$productId,$variantId,$fields=null,$excludeFields=null)
    {
        ...
        if($fields) $_params['fields'] = $fields;
        if($excludeFields) $_params['exclude_fields'] = $excludeFields;
        $this->master->call('ecommerce/stores/'.$storeId.'/products/'.$productId.'/variants/'.$variantId,$_params,SqualoMailMc::GET);
    }
                           ...
                           $inventoryQuantity=null,$imageUrl=null,$backorders=null,$visibility=null)
    {
        ...
        if($backorders) $_params['backorders'] = $backorders;
        if($visibility) $_params['visibility'] = $visibility;
        $this->master->call('ecommerce/stores/'.$storeId.'/products/'.$productId.'/variants/'.$variantId,$_params,Ebizmarts_SqualoMailMc::PATCH);
    }
                                ...
                                $inventoryQuantity=null,$imageUrl=null,$backorders=null,$visibility=null)
    {
        ...
        if($backorders) $_params['backorders'] = $backorders;
        if($visibility) $_params['visibility'] = $visibility;
        $this->master->call('ecommerce/stores/'.$storeId.'/products/'.$productId.'/variants/'.$variantId,$_params,Ebizmarts_SqualoMailMc::PUT);
    }
    /**
     * @param $storeId                  The store id.
     * @param $productId                The id for the product of a store.
    ...
    {
        $this->master->call('ecommerce/stores/'.$storeId.'/products/'.$productId.'/variants/'.$variantId,null,SqualoMailMc::DELETE);
    }
}
 ...
 */
class SqualoMailMc_ConversationsMessages extends SqualoMailMc_Abstract
{
    /**
    ...
    public function add($conversationId,$fromEmail,$subject=null,$message=null,$read=null)
    {
        ...
        return $this->master->call('conversations/'.$conversationId.'/messages',$_params,SqualoMailMc::POST);
    }
    ...
    public function getAll($conversationId,$fields=null,$excludeFields=null,$isRead=null,$beforeTimestamp=null,$sinceTimestamp=null)
    {
        ...
        return $this->master->call('conversation/'.$conversationId.'/messages',$_params,SqualoMailMc::GET);
    }
    ...
    public function get($conversationId,$messageId,$fields=null,$excludeFields=null)
    {
        ...
        if($fields) $_params['fields'] = $fields;
        if($excludeFields) $_params['exclude_fields'] = $excludeFields;
        return $this->master->call('conversation/'.$conversationId.'/messages/'.$messageId,$_params,SqualoMailMc::GET);
    }
}
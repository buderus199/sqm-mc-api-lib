 ...
 */
class SqualoMailMc_ListsSegmentsMembers extends SqualoMailMc_Abstract
{
    /**
    ...
    public function getAll($listId,$segmentId,$fields=null,$excludeFields=null,$count=null,$offset=null)
    {
        ...
        return $this->master->call('lists/'.$listId.'/segments/'.$segmentId.'/members',$_params,SqualoMailMc::GET);
    }
    ...
    public function add($listId,$segmentId,$emailAddress)
    {
        ...
        return $this->master->call('lists/'.$listId.'/segments/'.$segmentId.'/members',$_params,SqualoMailMc::POST);
    }
    public function delete($listId,$segmentId,$subscriberHash)
    {
        return $this->master->call('lists/'.$listId.'/segments/'.$segmentId.'/members/'.$subscriberHash,null,SqualoMailMc::DELETE);
    }
}
 ...
 */
class SqualoMailMc_CampaignsFeedback extends SqualoMailMc_Abstract
{
    /**
    ...
    public function add($campaignId,$blockId=null,$message,$isComplete=null)
    {
        ...
        return $this->master->call('campaigns/'.$campaignId.'/feedback',$_params,SqualoMailMc::POST);
    }
    ...
    public function getAll($campaignId,$fields=null,$excludeFields=null)
    {
        ...
        return $this->master->call('campaigns/'.$campaignId.'/feedback',$_params,SqualoMailMc::GET);
    }
    ...
    public function get($campaignId,$feedbackId,$fields=null,$excludeFields=null)
    {
        ...
        if($fields) $_params['fields'] = $fields;
        if($excludeFields) $_params['exclude_fields'] = $excludeFields;
        return $this->master->call('campaigns/'.$campaignId.'/feedback/'.$feedbackId,$_params,SqualoMailMc::GET);
    }
    ...
    public function modify($campaignId,$feedbackId,$blockId=null,$message,$isComplete)
    {
        ...
        if($blockId) $_params['block_id'] = $blockId;
        if($isComplete) $_params['is_complete'] = $isComplete;
        return $this->master->call('campaigns/'.$campaignId.'/feedback/'.$feedbackId,$_params,SqualoMailMc::PATCH);
    }
    ...
    {
        return $this->master->call('campaigns/'.$campaignId.'/feedback/'.$feedbackId,null,SqualoMailMc::DELETE);
    }
}
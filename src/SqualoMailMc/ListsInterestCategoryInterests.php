 ...
 */
class SqualoMailMc_ListInterestCategoryInterests extends SqualoMailMc_Abstract
{
    /**
    ...
    public function getAll($listId,$interestCategoryId,$fields=null,$excludeFields=null,$count=null,$offset=null)
    {
        ...
        return $this->master->call('lists/'.$listId.'/interest-categories/'.$interestCategoryId.'/interests',$_params,SqualoMailMc::GET);
    }
    ...
    public function get($listId,$interestCategoryId,$interestId,$fields=null,$excludeFields)
    {
        ...
        if($fields) $_params['fields'] = $fields;
        if($excludeFields) $_params['exclude_fields'] = $excludeFields;
        return $this->master->call('lists/'.$listId.'/interest-categories/'.$interestCategoryId.'/interests/'.$interestId,$_params,SqualoMailMc::GET);
    }
    ...
    public function modify($listId,$interestCategoryId,$interestId,$_listId=null,$name,$subscriberCount=null,$displayOrder=null)
    {
        ...
        return $this->master->call('lists/'.$listId.'/interest-categories/'.$interestCategoryId.'/interests/'.$interestId,$_params,SqualoMailMc::PATCH);
    }
    ...
    {
        return $this->master->call('lists/'.$listId.'/interest-categories/'.$interestCategoryId.'/interests/'.$interestId,null,SqualoMailMc::DELETE);
    }
}
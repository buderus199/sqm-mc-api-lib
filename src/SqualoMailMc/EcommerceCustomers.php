 ...
 */
class SqualoMailMc_EcommerceCustomers extends SqualoMailMc_Abstract
{
    /**
    ...
    public function add($storeId,$id,$emailAddress,$optInStatus,$company=null,$firstName=null,$lastName=null,$ordersCount=null,$totalSpent=null,$address=null)
    {
        ...
        return $this->master->call('ecommerce/stores/'.$storeId.'/customers',$_params,SqualoMailMc::POST);
    }
    ...
    public function getAll($storeId,$fields=null,$excludeFields=null,$count=null,$offset=null)
    {
        ...
        return $this->master->call('ecommerce/stores/'.$storeId.'/customers',$_params,SqualoMailMc::GET);
    }
    ...
    public function get($storeId,$customerId,$fields=null,$excludeFields=null)
    {
        ...
        if($fields) $_params['fields']= $fields;
        if($excludeFields) $_params['exclude_fields'] = $excludeFields;
        return $this->master->call('ecommerce/stores/'.$storeId.'/customers/'.$customerId,$_params,SqualoMailMc::GET);
    }
    /**
     * @param $storeId              The store id.
                           ...
                           $totalSpent=null,$address=null)
    {
        ...
        if($totalSpent) $_params['total_spent'] = $totalSpent;
        if($address) $_params['address'] = $address;
        return $this->master->call('ecommerce/stores/'.$storeId.'/customers/'.$customerId,$_params,SqualoMailMc::PATCH);
    }
    ...
    public function addOrModify($storeId,$customerId,$emailAddress,$optInStatus,$company=null,$firstName=null,$lastName=null,$ordersCount=null,$totalSpent=null,$address=null)
    {
        ...
        if($totalSpent) $_params['total_spent'] = $totalSpent;
        if($address) $_params['address'] = $address;
        return $this->master->call('ecommerce/stores/'.$storeId.'/customers/'.$customerId,$_params,SqualoMailMc::PUT);
    }
    ...
    {
        return $this->master->call('ecommerce/stores/'.$storeId.'/customers/'.$customerId,null,SqualoMailMc::DELETE);
    }
}
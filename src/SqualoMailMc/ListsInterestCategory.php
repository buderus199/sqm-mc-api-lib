 ...
 */
class SqualoMailMc_ListsInterestCategory extends SqualoMailMc_Abstract
{
    /**
     * @var SqualoMailMc_ListInterestCategoryInterests
     */
    public $interests;
    ...
    public function add($listId,$title,$displayOrder=null,$type=null)
    {
        ...
        return $this->master->call('lists/'.$listId.'/interest-categories',$_params,SqualoMailMc::POST);
    }
    ...
    public function getAll($listId,$fields=null,$excludeFields=null,$count=null,$offset=null,$type=null)
    {
        ...
        return $this->master->call('lists/'.$listId.'/interest-categories',$_params,SqualoMailMc::GET);
    }
    ...
    public function get($listId,$interestCategoryId,$fields=null,$excludeFields=null)
    {
        ...
        if($fields) $_params['fields'] = $fields;
        if($excludeFields) $_params['exclude_fields'] = $excludeFields;
        return $this->master->call('lists/'.$listId.'/interest-categories/'.$interestCategoryId,$_params,SqualoMailMc::GET);
    }
    ...
    public function modify($listId,$interestCategoryId,$title,$displayOrder=null,$type=null)
    {
        $_params = array('title'=>$title,'type'=>$type);
        if($displayOrder) $_params['display_order'] = $displayOrder;
        return $this->master->call('lists/'.$listId.'/interest-categories/'.$interestCategoryId,$_params,SqualoMailMc::PATCH);
    }
    ...
    {
        return $this->master->call('lists/'.$listId.'/interest-categories/'.$interestCategoryId,null,SqualoMailMc::DELETE);
    }

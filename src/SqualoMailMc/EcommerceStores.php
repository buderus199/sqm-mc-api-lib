 ...
 */
class SqualoMailMc_EcommerceStore  extends SqualoMailMc_Abstract
{
    /**
                        ...
                        $primaryLocale=null, $timezone = null,$phone=null,$address=null,$is_sync=null)
    {
        ...
        return $this->master->call('ecommerce/stores',$_params,SqualoMailMc::POST);
    }
    ...
    public function get($id=null,$fields=null,$excludeFields=null,$count=null,$offset=null)
    {
        ...
        if($id) {
            return $this->master->call('ecommerce/stores/'.$id, $_params, SqualoMailMc::GET);
        }
        else {
            return $this->master->call('ecommerce/stores', $_params, SqualoMailMc::GET);
        }
    }
                         ...
                         $primaryLocale=null, $timezone = null,$phone=null,$address=null, $is_sync=null)
    {
        ...
        if($address)  $_params['address'] = $address;
        if($is_sync!==null) $_params['is_syncing'] = $is_sync;
        return $this->master->call('ecommerce/stores/'.$storeId, $_params, SqualoMailMc::PATCH);
    }
    ...
    {
        return $this->master->call('ecommerce/stores/'.$storeId, null, SqualoMailMc::DELETE);
    }
}